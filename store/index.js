...
const store = new Vuex.Store({
	...
	mutations: {
		// 品类一级
		getOneKindList(state, oneKindList) {
			// console.log(oneKindList,'vuex...')
			state.oneKindList = oneKindList
		},
		// 首页通知数量
		getInformNumber(state, informNumber) {
			state.informNumber = informNumber
		},
		// 省区域
		provinceListFun(state, provinceList) {
		...
		updateConversationActive(state, conversationItem) {
			console.log(conversationItem, '123conversationItem')
