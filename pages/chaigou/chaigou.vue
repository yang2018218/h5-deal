				...
				<form @submit="indexSubmit">
					<view class="uni-form-item uni-column">
						...
						<view class="ask">
							...
							<textarea @blur="bindTextAreaBlur" style="border: 1rpx solid #acacac;border-radius: 15rpx; height: 100rpx;text-indent: 10rpx;padding: 5rpx 0;"
							 placeholder="请输入采购要求" v-model="supplyNote" />
							</view>
						<view class="img_box">
